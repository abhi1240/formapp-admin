                             ...
                             <tbody>
                              ...
                              <tr>
                                ...
                                @php $img_id = Crypt::encrypt($job['img_id']); @endphp
                                  <td><a href="{{route('quality_controller.approved_jobs_view',$img_id)}}" class="custom_btn_primary text-primary update_record mr-2"  data-toggle="tooltip" title="view record"> <i class="la la-eye p-2"></i> </a></td>
                              </tr>
                              @empty
                             @endforelse
                            @endisset
