        ...
        <div class="row">
           <div class="col-lg-12">
              <div class="breadcrumb-main">
                 <h4 class="text-capitalize breadcrumb-title">Rejected Jobs</h4>
              </div>
           </div>
        </div>
        <div class="row">
                             ...
                             <tbody>
                              ...
                              <tr>
                                ...
                                @php $img_id = Crypt::encrypt($job['img_id']); @endphp
                                  <td><a href="{{route('quality_controller.rejected_jobs_view',$img_id)}}" class="custom_btn_primary text-primary update_record mr-2"  data-toggle="tooltip" title="view record"> <i class="la la-eye p-2"></i> </a></td>
                              </tr>
                              @empty
                             @endforelse
                            @endisset
