...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}"
   ...
   <head>
    ...
    <meta name="url" content="{{ url('/') }}" />
      ...
      @include('quality-controller.layouts.partials._styles')
      {{-- Includable CSS --}}
      @yield('styles')
      {{-- Endinject --}}
   ...
   <body class="layout-light side-menu @auth() overlayScroll @endauth">
      ...
      @include('quality-controller.layouts.partials._header')
      @endauth
      <main class="main-content">
         @auth()
            @include('quality-controller.layouts.partials._aside')
         @endauth
         @section('content')
         @show
         @auth()
            @include('quality-controller.layouts.partials._footer')
         @endauth
      </main>
      @auth()
      <div id="overlayer">
      ...
      @yield('mapScript')
      @include('quality-controller.layouts.partials._scripts')
      {{-- Includable JS --}}
      @yield('scripts')
      {{-- Endinject --}}
   </body>
