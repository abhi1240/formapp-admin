                ...
                <div class="g-mb-50">
                  <div class="alert alert-danger alert-dismissable">
                    <a href="#" class="close mr-2" data-dismiss="alert" aria-label="close">&times;</a>
                      This site doesn't have register form please login to continue.
                  </div>
                    <a href="{{route('login')}}" class="btn btn-md btn-block u-btn-primary rounded text-uppercase g-py-13"  >Login</a>
                </div>
                </div>
            </div>
