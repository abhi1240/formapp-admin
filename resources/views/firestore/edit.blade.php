                  ...
                  <div class="edit-profile__body">
                     <form method="POST" action="{{ route('firestore.update', $basicInfo->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group mb-25">
                           ...
                           <input type="text" class="form-control" id="phoneNumber2" name="position" placeholder="Position" value="{{ (!empty($basicInfo->position) ? $basicInfo->position : '') }}">
                        </div>
                        <div class="form-group mb-25 status-radio">
                           ...
                           <div class="d-flex">
                              <div class="radio-horizontal-list d-flex flex-wrap">
                                 ...
                                 <div class="radio-theme-default custom-radio ">
                                    <input class="radio" type="radio" name="status" value="bloked" id="radio-hl3" {{ ($basicInfo->status=='bloked' ? 'checked' : '') }}>
                                    <label for="radio-hl3">
