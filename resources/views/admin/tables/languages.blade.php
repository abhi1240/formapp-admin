	      ...
	      <div class="row mb-30 mt-3">
	         <div class="col-lg-6 col-md-6">
	            <div class="card">
                   ...
                   <span><i class="fas fa-bars mr-2"></i>Languages List</span>
	               </div>
	               <div class="card-body">
           ...
           <div class="col-lg-6 col-md-6">
             <div class="card">
               <div class="card-header color-dark fw-500">
                  <span><i class="fas fa-file-alt mr-2"></i>Manage Languages</span>
               </div>
               <div class="card-body">
                   ...
                   <div class="row">
                     <div class="col-md-6 col-lg-6">
                       <div class="form-group">
                         ...
                         <input type="text" name="name" class="form-control" value="" placeholder="Enter language name" id="name" required="required">
                       </div>
                     </div>
                     <div class="col-md-3 col-lg-3">
                       <label for="" class="invisible">button</label>
                       <a href="#" class="btn btn-primary btn-block btn-sm" id="languages_form">Save</a>
                     </div>
                   </div>
                 </form>
               </div>
...
@section('scripts')
	...
	$(document).on('click', '#languages_form', function(){
		var name = $("#name").val();
		...
		$.ajax({
			...
			url: url + '/admin/tables/languages_store',
			data:{
				name:name,
			},
			dataType: "json",
    ...
    $.ajax({
      type: "POST",
      headers: { 'X-CSRF-TOKEN': csrf_token },
      url: url + '/admin/tables/languages_remove',
      data:{
        id:id,
      },
      dataType: "json",
    ...
    $.ajax({
      type: "POST",
      headers: { 'X-CSRF-TOKEN': csrf_token },
      url: url + '/admin/tables/languages_update',
      data:{
        id:id,
        name:name,
      },
	...
	$('.active_inactive').change(function () {
			...
			$.ajax({
				type: "GET",
				url: url + '/admin/tables/languages_status_update',
				data:{
					id:id,
					status:status,
				},
