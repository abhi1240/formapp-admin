                   ...
                   <div class="row">
                     <div class="col-md-6 col-lg-6">
                       <div class="form-group">
                         ...
                         <input type="text" name="name" class="form-control" value="" placeholder="Enter language name" id="name" required>
                       </div>
                     </div>
...
@section('scripts')
	...
	$(document).on('click', '#languages_form', function(){
		...
		$.ajax({
			...
			url: url + '/support/tables/languages_store',
			data:{
				name:name,
			},
			dataType: "json",
    ...
    $.ajax({
      type: "POST",
      headers: { 'X-CSRF-TOKEN': csrf_token },
      url: url + '/support/tables/languages_remove',
      data:{
        id:id,
      },
      dataType: "json",
    ...
    $.ajax({
      type: "POST",
      headers: { 'X-CSRF-TOKEN': csrf_token },
      url: url + '/support/tables/languages_update',
      data:{
        id:id,
        name:name,
      },
	...
	$('.active_inactive').change(function () {
			...
			$.ajax({
				type: "GET",
				url: url + '/support/tables/languages_status_update',
				data:{
					id:id,
					status:status,
				},
