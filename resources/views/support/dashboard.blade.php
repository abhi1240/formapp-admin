      ...
      <div class="row mt-3">
            <div class="col-md-3 col-lg-3">
                <div class="card p-3">
                  ...
                  <a href="{{route('support.pending.images')}}" class="font-weight-light view_txt1 mb-0 mt-1"> View Explorer <span><i class="fas fa-arrow-circle-right ml-2"></i></span> </a>
                </div>
            </div>
            <div class="col-md-3 col-lg-3">
                <div class="card p-3">
                  ...
                  <a href="{{route('support.approved.images')}}" class="font-weight-light view_txt2 mb-0 mt-1 "> View Explorer <span><i class="fas fa-arrow-circle-right ml-2"></i></span> </a>
                </div>
            </div>
            <div class="col-md-3 col-lg-3">
                <div class="card p-3">
                  ...
                  <a  href="{{route('support.rejected.images')}}" class="font-weight-light view_txt3 mb-0 mt-1 "> View Explorer <span><i class="fas fa-arrow-circle-right ml-2"></i></span> </a>
                </div>
            </div>
            {{-- <div class="col-md-3 col-lg-3">
                <div class="card p-3">
