                              ...
                              <div class="account-profile border-bottom pt-25 px-25 pb-0 flex-column d-flex align-items-center ">
                                  <div class="ap-img mb-20 pro_img_wrapper">
                                      <label for="file-upload">
                                          ...
                                          @if($support->profile_pic_url)
                                            <img class="ap-img__main rounded-circle wh-120" src="{{$support->profile_pic_url}}" alt="profile">
                                          @else
                                  ...
                                  <div class="ap-nameAddress pb-3">
                                      <h5 class="ap-nameAddress__title">{{$support->name}}</h5>
                                      <p class="ap-nameAddress__subTitle fs-14 m-0">{{$support->email}}</p>
                                      <p class="ap-nameAddress__subTitle fs-14 m-0">Support</p>
                                  ...
                                  <form class="mt-1" action="{{route('support.upload.profile.photo')}}" method="post" enctype="multipart/form-data" id="profile-tab" style="display:none;">
                                    @csrf
                                              ...
                                              <div class="row justify-content-center">
                                                  <div class="col-xl-6 col-lg-8 col-sm-10">
                                                      <div class="edit-profile__body mx-lg-20">
                                                        <form class="" action="{{route('update.support-info')}}" method="post">
                                                          @csrf
                                                          <input type="hidden" name="id" value="{{$support->id}}">
                                                              <div class="form-group mb-20">
                                                                  <label for="names">name</label>
                                                                  <input type="text" class="form-control" name="name" @isset($support->name)
                                                                    value="{{$support->name}}"
                                                                  @endisset>
                                                              </div>
                                                              <div class="form-group mb-20">
                                                                  <label for="phoneNumber1">User Id</label>
                                                                  <input type="text" class="form-control" name="seeder_id"   @isset($support->user_id)
                                                                    value="{{$support->user_id}}"
                                                                  @endisset readonly>
                                                              </div>
                                                              <div class="form-group mb-20">
                                                                  <label for="company1">company name</label>
                                                                  <input type="text" class="form-control" name="company_name" @isset($support->company_name)
                                                                    value="{{$support->company_name}}"
                                                                  @endisset >
                                                              </div>
                                                              <div class="form-group mb-20">
                                                                  <label for="website">Position</label>
                                                                  <input type="text" class="form-control" name="position" @isset($support->position)
                                                                    value="{{$support->position}}"
                                                                  @endisset >
                                                              </div>
                                                              <div class="form-group mb-20">
                                                                  <label for="userBio">Primary email address</label>
                                                                  <input type="email" class="form-control" name="email" @isset($support->email)
                                                                    value="{{$support->email}}"
                                                                  @endisset >
                                                              </div>
                                                              <div class="form-group mb-20">
                                                                  <label for="userBio">Linked account</label>
                                                                  <input type="text" class="form-control" name="linked_account" @isset($support->linked_account)
                                                                    value="{{$support->linked_account}}"
                                                                  @endisset>
                                                              </div>
                                                              <div class="form-group mb-20">
                                                                  <label for="userBio">Website</label>
                                                                  <input type="text" class="form-control" name="website" @isset($support->website)
                                                                    value="{{$support->website}}"
                                                                  @endisset >
                                                              </div>
                                                              <div class="form-group mb-20">
                                                                  <label for="userBio">Phone number</label>
                                                                  <input type="text" class="form-control" name="phone_num" @isset($support->phone_num)
                                                                    value="{{$support->phone_num}}"
                                                                  @endisset >
                                                              </div>
                                                              <div class="form-group mb-20">
                                                                  <label for="userBio">Office number</label>
                                                                  <input type="text" class="form-control" name="office_num" @isset($support->office_num)
                                                                    value="{{$support->office_num}}"
                                                                  @endisset >
                                                              </div>
                                                              <div class="form-group mb-20">
                                                                  <label for="userBio">Address</label>
                                                                  <textarea  class="form-control" name="address" @isset($support->address)
                                      ...
                                      <div class="card">
                                          ...
                                          <div class="card-body">
                                              <div class="row justify-content-center">
                                                  <div class="col-lg-6">
                                                      <div class="edit-profile__body mx-lg-20">
                                                        <form class="" action="{{route('support.reset-password')}}" method="post" >
                                                          @csrf
                                                          <input type="hidden" name="id" value="{{$support->id}}">
                                                          <div class="form-group mb-20">
