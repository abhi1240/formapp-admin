...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}"
   ...
   <head>
    ...
    <meta name="url" content="{{ url('/') }}" />
      ...
      @include('quality-checker.layouts.partials._styles')
      {{-- Includable CSS --}}
      @yield('styles')
      {{-- Endinject --}}
   ...
   <body class="layout-light side-menu @auth() overlayScroll @endauth">
      ...
      @include('quality-checker.layouts.partials._header')
      @endauth
      <main class="main-content">
         @auth()
            @include('quality-checker.layouts.partials._aside')
         @endauth
         @section('content')
         @show
         @auth()
            @include('quality-checker.layouts.partials._footer')
         @endauth
      </main>
      @auth()
      <div id="overlayer">
      ...
      @yield('mapScript')
      @include('quality-checker.layouts.partials._scripts')
      {{-- Includable JS --}}
      @yield('scripts')
      {{-- Endinject --}}
   </body>
