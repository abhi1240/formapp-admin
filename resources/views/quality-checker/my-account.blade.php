                              ...
                              <div class="account-profile border-bottom pt-25 px-25 pb-0 flex-column d-flex align-items-center ">
                                  <div class="ap-img mb-20 pro_img_wrapper">
                                      <label for="file-upload">
                                          ...
                                          @if($qchecker->profile_pic_url)
                                            <img class="ap-img__main rounded-circle wh-120" src="{{$qchecker->profile_pic_url}}" alt="profile">
                                          @else
                                  ...
                                  <div class="ap-nameAddress pb-3">
                                      <h5 class="ap-nameAddress__title">{{$qchecker->name}}</h5>
                                      <p class="ap-nameAddress__subTitle fs-14 m-0">{{$qchecker->email}}</p>
                                      <p class="ap-nameAddress__subTitle fs-14 m-0">Image Quality Checker</p>
                                  ...
                                  <form class="mt-1" action="{{route('quality_checker.upload.profile.photo')}}" method="post" enctype="multipart/form-data" id="profile-tab" style="display:none;">
                                    @csrf
                                    <input type="hidden" name="id" value="{{$qchecker->id}}">
                                    <div class="row">
                                              ...
                                              <div class="row justify-content-center">
                                                  <div class="col-xl-6 col-lg-8 col-sm-10">
                                                      <div class="edit-profile__body mx-lg-20">
                                                        <form class="" action="{{route('update.quality_checker_info')}}" method="post">
                                                          @csrf
                                                          <input type="hidden" name="id" value="{{$qchecker->id}}">
                                                              <div class="form-group mb-20">
                                                                  <label for="names">name</label>
                                                                  <input type="text" class="form-control" name="name" @isset($qchecker->name)
                                                                    value="{{$qchecker->name}}"
                                                                  @endisset>
                                                              </div>
                                                              <div class="form-group mb-20">
                                                                  <label for="phoneNumber1">User Id</label>
                                                                  <input type="text" class="form-control" name="seeder_id"   @isset($qchecker->user_id)
                                                                    value="{{$qchecker->user_id}}"
                                                                  @endisset readonly>
                                                              </div>
                                                              <div class="form-group mb-20">
                                                                  <label for="company1">company name</label>
                                                                  <input type="text" class="form-control" name="company_name" @isset($qchecker->company_name)
                                                                    value="{{$qchecker->company_name}}"
                                                                  @endisset >
                                                              </div>
                                                              <div class="form-group mb-20">
                                                                  <label for="website">Position</label>
                                                                  <input type="text" class="form-control" name="position" @isset($qchecker->position)
                                                                    value="{{$qchecker->position}}"
                                                                  @endisset >
                                                              </div>
                                                              <div class="form-group mb-20">
                                                                  <label for="userBio">Primary email address</label>
                                                                  <input type="email" class="form-control" name="email" @isset($qchecker->email)
                                                                    value="{{$qchecker->email}}"
                                                                  @endisset >
                                                              </div>
                                                              <div class="form-group mb-20">
                                                                  <label for="userBio">Linked account</label>
                                                                  <input type="text" class="form-control" name="linked_account" @isset($qchecker->linked_account)
                                                                    value="{{$qchecker->linked_account}}"
                                                                  @endisset>
                                                              </div>
                                                              <div class="form-group mb-20">
                                                                  <label for="userBio">Website</label>
                                                                  <input type="text" class="form-control" name="website" @isset($qchecker->website)
                                                                    value="{{$qchecker->website}}"
                                                                  @endisset >
                                                              </div>
                                                              <div class="form-group mb-20">
                                                                  <label for="userBio">Phone number</label>
                                                                  <input type="text" class="form-control" name="phone_num" @isset($qchecker->phone_num)
                                                                    value="{{$qchecker->phone_num}}"
                                                                  @endisset >
                                                              </div>
                                                              <div class="form-group mb-20">
                                                                  <label for="userBio">Office number</label>
                                                                  <input type="text" class="form-control" name="office_num" @isset($qchecker->office_num)
                                                                    value="{{$qchecker->office_num}}"
                                                                  @endisset >
                                                              </div>
                                                              <div class="form-group mb-20">
                                                                  <label for="userBio">Address</label>
                                                                  <textarea  class="form-control" name="address" @isset($qchecker->address)
                                                                    value="{{$qchecker->address}}"
                                                                  @endisset></textarea>
                                                              </div>
                                      ...
                                      <div class="card">
                                          ...
                                          <div class="card-body">
                                              <div class="row justify-content-center">
                                                  <div class="col-lg-6">
                                                      <div class="edit-profile__body mx-lg-20">
                                                        <form class="" action="{{route('quality_checker.reset-password')}}" method="post" >
                                                          @csrf
                                                          <input type="hidden" name="id" value="{{$qchecker->id}}">
                                                          <div class="form-group mb-20">
