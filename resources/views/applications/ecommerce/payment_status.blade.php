...
@section('content')
    <div class="contents">
        ...
        <div class="container-fluid">
            <div class=" global-shadow checkout-review border py-30 px-sm-50 px-30 bg-white radius-xl w-100 mb-30">
                <div class="row">
                    <div class="col-lg-10">
                        ...
                        </div><!-- End: .checkout-progress-indicator -->
                        <div class="row justify-content-center">
                            ...
                            <div class="col-lg-3"></div><!-- End: .col-lg-3 -->
                        </div>
                    </div><!-- End: .col-lg-10 -->
                    <div class="col-lg-2"></div><!-- End: .col-lg-2 -->
                </div>
            </div><!-- End: .checkout-review -->
        </div>
    </div>
@endsection
