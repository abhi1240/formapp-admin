                        ...
                        <div class="row justify-content-center">
                            <div class="col-xl-6 col-lg-8 col-sm-10">
                                                    ...
                                                    <div class="form-cc">
                                                        ...
                                                        <div class="form-group mb-30">
                                                            ...
                                                            <div class="d-flex flex-wrap flex-lg-nowrap mb-md-15">
                                                                <div class="w-100 mr-xl-20 mb-20">
                                ...
                                <div class="button-group d-flex pt-40 mb-xl-20  justify-content-sm-between justify-content-center m-0 mb-xl-30 mb-30 flex-wrap">
                                    <a href="{{ route('applications.ecommerce.shippingAddress') }}" class="btn btn-light btn-default btn-squared fw-400 text-capitalize m-sm-0 m-1"><i class="las la-arrow-left mr-10"></i>Previous</a>
                                    <a href="{{ route('applications.ecommerce.checkoutReview') }} " class="btn text-white btn-primary btn-default btn-squared text-capitalize m-sm-0 m-1">Save &
