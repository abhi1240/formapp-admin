...
@section('content')
    <div class="contents">
        ...
        <div class="products_page product_page--list">
            <div class="container-fluid">
                <div class="row justify-content-center">
                    <div class="columns-1 col-lg-4 col-md-4  order-md-0 order-1 ">
                        <div class="widget mb-30">
                            <div class="widget-header-title px-20 py-15 border-bottom">
                                <h6 class="d-flex align-content-center fw-500"><span data-feather="sliders"></span> Filters</h6>
                            </div>
                    ...
                    <div class="columns-2 col-lg-8 col-md-8 order-md-1 order-0">
                        <!-- Start: Top Bar -->
                        <div class="shop_products_top_filter">
                            <div class="project-top-wrapper d-flex justify-content-between flex-wrap align-items-center">
                                ...
                                <div class="project-top-right d-flex justify-content-between flex-wrap align-items-center">
                                    ...
                                    <div class="project-icon-selected content-center mt-lg-0 mt-25">
                                        <div class="listing-social-link pb-lg-0 pb-xs-2">
                                            <div class="icon-list-social d-flex">
                                                <a class="icon-list-social__link rounded-circle icon-list-social__style justify-content-center  ml-xl-20 mr-20" href="{{ route('applications.ecommerce.products') }}"><span data-feather="grid"></span></a>
                                            ...
                                            <div class="h-100">
                                                <div class="product-item">
                                                    <div class="product-item__image">
                                                        <img src="{{ asset('img/digital-chair.png') }}" alt="digital-chair">
                                                    </div>
                                                    <div class="product-item__body mt-xl-20 mt-0 position-relative">
                                                        ...
                                                        <div class="product-item__content text-capitalize">
                                                            ...
                                                            <div class="product-item__button d-xl-block d-flex flex-wrap">
                                                                <button class="btn btn-default btn-squared btn-outline-light ml-lg-0 ml-0 mr-2 mb-lg-10"><span data-feather="shopping-bag"></span>
                                                                    Add To Cart
                                                                </button>
                                                                <button class="btn btn-primary btn-default btn-squared border-0 ml-0">buy now
                                                                </button>
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="col-12 mb-30 px-10">
                                        <div class="card product product--list">
                                            <div class="h-100">
                                                <div class="product-item">
                                                    <div class="product-item__image">
                                                        <img src="{{ asset('img/glass-cup.png') }}" alt="digital-chair">
                                                    </div>
                                                    <div class="product-item__body mt-xl-20 mt-0 position-relative">
                                                            <span class="like-icon">
                                                                <button type="button" class="content-center">
                                    ...
                                    <div class="col-12 mb-30 px-10">
                                        <div class="card product product--list">
                                            <div class="h-100">
                                                <div class="product-item">
                                                    <div class="product-item__image">
                                                        <img src="{{ asset('img/chair2.png') }}" alt="digital-chair">
                                                    </div>
                                                    <div class="product-item__body mt-xl-20 mt-0 position-relative">
                                                            <span class="like-icon">
                                                                <button type="button" class="content-center">
                                    ...
                                    <div class="col-12 mb-30 px-10">
                                        <div class="card product product--list">
                                            <div class="h-100">
                                                <div class="product-item">
                                                    <div class="product-item__image">
                                                        <img src="{{ asset('img/chair.png') }}" alt="digital-chair">
                                                    </div>
                                                    <div class="product-item__body mt-xl-20 mt-0 position-relative">
                                                            <span class="like-icon">
                                                                <button type="button" class="content-center">
                                    ...
                                    <div class="col-12 mb-30 px-10">
                                        <div class="card product product--list">
                                            <div class="h-100">
                                                <div class="product-item">
                                                    <div class="product-item__image">
                                                        <img src="{{ asset('img/plate.png') }}" alt="digital-chair">
                                                    </div>
                                                    <div class="product-item__body mt-xl-20 mt-0 position-relative">
                                                            <span class="like-icon">
                                                                <button type="button" class="content-center">
                                    ...
                                    <div class="col-12 mb-30 px-10">
                                        <div class="card product product--list">
                                            <div class="h-100">
                                                <div class="product-item">
                                                    <div class="product-item__image">
                                                        <img src="{{ asset('img/boss-chair.png') }}" alt="digital-chair">
                                                    </div>
                                                    <div class="product-item__body mt-xl-20 mt-0 position-relative">
                                                            <span class="like-icon">
                                                                <button type="button" class="content-center">
                                    ...
                                    <div class="col-12 mb-30 px-10">
                                        <div class="card product product--list">
                                            <div class="h-100">
                                                <div class="product-item">
                                                    <div class="product-item__image">
                                                        <img src="{{ asset('img/only-juss.png') }}" alt="digital-chair">
                                                    </div>
                                                    <div class="product-item__body mt-xl-20 mt-0 position-relative">
                                                            <span class="like-icon">
                                                                <button type="button" class="content-center">
                                    ...
                                    <div class="col-12 mb-30 px-10">
                                        <div class="card product product--list">
                                            <div class="h-100">
                                                <div class="product-item">
                                                    <div class="product-item__image">
                                                        <img src="{{ asset('img/flip-chair.png') }}" alt="digital-chair">
                                                    </div>
                                                    <div class="product-item__body mt-xl-20 mt-0 position-relative">
                                                            <span class="like-icon">
                                                                <button type="button" class="content-center">
                                    ...
                                    <div class="col-12 mb-30 px-10">
                                        <div class="card product product--list">
                                            <div class="h-100">
                                                <div class="product-item">
                                                    <div class="product-item__image">
                                                        <img src="{{ asset('img/chair3.png') }}" alt="digital-chair">
                                                    </div>
                                                    <div class="product-item__body mt-xl-20 mt-0 position-relative">
                                                            <span class="like-icon">
                                                                <button type="button" class="content-center">
                                    ...
                                    <div class="col-12 mb-30 px-10">
                                        <div class="card product product--list">
                                            <div class="h-100">
                                                <div class="product-item">
                                                    <div class="product-item__image">
                                                        <img src="{{ asset('img/juse.png') }}" alt="digital-chair">
                                                    </div>
                                                    <div class="product-item__body mt-xl-20 mt-0 position-relative">
                                                            <span class="like-icon">
                                                                <button type="button" class="content-center">
                                    ...
                                    <div class="col-12 mb-30 px-10">
                                        <div class="card product product--list">
                                            <div class="h-100">
                                                <div class="product-item">
                                                    <div class="product-item__image">
                                                        <img src="{{ asset('img/coffe-glass.png') }}" alt="digital-chair">
                                                    </div>
                                                    <div class="product-item__body mt-xl-20 mt-0 position-relative">
                                                            <span class="like-icon">
                                                                <button type="button" class="content-center">
