                                                ...
                                                <div class="add-new-contact">
                                                    <form action="/">
                                                        ...
                                                        <div class="button-group d-flex pt-20">
                                                            <button class="btn btn-primary btn-default btn-squared ">add
                                                                new Contact
                                                            </button>
                                                        </div>
                                                    </form>
                                            ...
                                            <div class="contact-item d-flex align-items-center">
                                                ...
                                                <div class="contact-personal-info d-flex">
                                                    <a href="#" class="profile-image rounded-circle d-block m-0 wh-38"
                                                       style="background-image:url('{{ asset('img/tm6.png') }}'); background-size: cover;"></a>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="contact-item d-flex align-items-center">
                                                ...
                                                <div class="contact-personal-info d-flex">
                                                    <a href="#" class="profile-image rounded-circle d-block m-0 wh-38"
                                                       style="background-image:url('{{ asset('img/tm1.png') }}'); background-size: cover;"></a>
                                                    <div class="contact_title">
                                                        <h6>
                                                            <a href="#">Kellie Marquot</a>
                                                        </h6>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="contact-item d-flex align-items-center">
                                                ...
                                                <div class="contact-personal-info d-flex">
                                                    <a href="#" class="profile-image rounded-circle d-block m-0 wh-38"
                                                       style="background-image:url('{{ asset('img/tm2.png') }}'); background-size: cover;"></a>
                                                    <div class="contact_title">
                                                        <h6>
                                                            <a href="#">Kellie Marquot</a>
                                                        </h6>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="contact-item d-flex align-items-center">
                                                ...
                                                <div class="contact-personal-info d-flex">
                                                    <a href="#" class="profile-image rounded-circle d-block m-0 wh-38"
                                                       style="background-image:url('{{ asset('img/tm3.png') }}'); background-size: cover;"></a>
                                                    <div class="contact_title">
                                                        <h6>
                                                            <a href="#">Kellie Marquot</a>
                                                        </h6>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="contact-item d-flex align-items-center">
                                                ...
                                                <div class="contact-personal-info d-flex">
                                                    <a href="#" class="profile-image rounded-circle d-block m-0 wh-38"
                                                       style="background-image:url('{{ asset('img/tm5.png') }}'); background-size: cover;"></a>
                                                    <div class="contact_title">
                                                        <h6>
                                                            <a href="#">Kellie Marquot</a>
                                                        </h6>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="contact-item d-flex align-items-center">
                                                ...
                                                <div class="contact-personal-info d-flex">
                                                    <a href="#" class="profile-image rounded-circle d-block m-0 wh-38"
                                                       style="background-image:url('{{ asset('img/tm7.png') }}'); background-size: cover;"></a>
                                                    <div class="contact_title">
                                                        <h6>
                                                            <a href="#">Kellie Marquot</a>
                                                        </h6>
